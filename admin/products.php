...
<section class="card product-manager-card">
 ...
 <div class="product-manager-meta"><span>RAM <b><?=e($r['ram_mb'])?> MB</b></span><span>CPU <b><?=e($r['cpu_percent'])?>%</b></span><span>Disk <b><?=e($r['disk_mb'])?> MB</b></span><span>Software <b><?=count($productEggs)?> option<?=count($productEggs)===1?'':'s'?></b></span><span>Node <b><?=e($r['ptero_node_id']?:'Auto')?></b></span><span>Stock <b><?=($r['stock']===null?'Unlimited':e($r['stock']))?></b></span></div>
