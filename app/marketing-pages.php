...
function render_marketing_page(string $key): void
{
    ...
    $schema = [
        ...
        'description' => $page['description'], 'provider' => ['@type'=>'Person','name'=>'Beke, Louis','url'=>'https://foxnetwork.be/'],
